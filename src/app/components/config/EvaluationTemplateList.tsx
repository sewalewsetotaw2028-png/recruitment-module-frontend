...
export const EvaluationTemplateList: React.FC<
  EvaluationTemplateListProps
> = ({
  templates,
  selectedTemplateId,
  loading,
        ...
        {loading ? (
          ...
          templates.map((template) => {
            ...
            return (
              <div
                key={template.id}
                className={`w-full text-left px-4 py-3 flex items-center justify-between gap-3 transition-all rounded-xl border ${
                  isSelected
